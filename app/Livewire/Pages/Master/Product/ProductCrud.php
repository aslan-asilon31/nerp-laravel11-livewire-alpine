...
use App\Livewire\Pages\Master\Product\Forms\ProductForm;
...
class ProductCrud extends Component
{
  ...
  public function render()
  {
    ...
    // $companies = Company::select('id', 'name')->get()->map(function ($company) {})->toArray();

    // dd($companies);


    return view('livewire.pages.master.product.product-crud', [
      'companies' => $companies,
    ])
