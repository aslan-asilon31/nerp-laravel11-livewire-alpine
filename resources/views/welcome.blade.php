    ...
    >
      ...
      >
        <div class="hidden md:flex md:w-1/2 h-full">
          <img
            class="w-full h-full"
            src="{{ asset('frontend-assets/images/newsletter.png') }}"
            alt="newsletter"
          />
        </div>
        <div
        ...
        >
          ...
          <button
            class="rounded-md self-center py-2 px-3 bg-gray-900 text-white hover:bg-purple-500"
          >
            SUBSCRIBE
          </button>
        </div>
              ...
              >
                <li>
                  ...
                  <ul class="flex flex-col items-start justify-start gap-2">
                    ...
                    <li>
                      <img
                        src="{{ asset('frontend-assets/images/electronics-banner-1.jpg') }}"
                        alt="pic"
                      />
                    </li>
                  </ul>
                ...
                <li>
                  ...
                  <ul class="flex flex-col items-start justify-start gap-2">
                    ...
                    <li>
                      <img
                        src="{{ asset('frontend-assets/images/electronics-banner-2.jpg') }}"
                        alt="pic"
                      />
                    </li>
                  </ul>
              ...
              <details>
                ...
                <summary>
                  <div class="flex items-center gap-2">
                    ...
                    <img
                      class="w-4 h-4"
                      src="{{ asset('frontend-assets/images/icons/dress.svg') }}"
                      alt="productPicture"
                    />
                  </div>
                </summary>
              ...
              <details>
                ...
                <summary>
                  <div class="flex items-center gap-2">
                    ...
                    <img
                      class="w-4 h-4"
                      src="{{ asset('frontend-assets/images/icons/shoes.svg') }}"
                      alt="productPicture"
                    />
                  </div>
                </summary>
              ...
              <details>
                ...
                <summary>
                  <div class="flex items-center gap-2">
                    ...
                    <img
                      class="w-4 h-4"
                      src="{{ asset('frontend-assets/images/icons/jewelry.svg') }}"
                      alt="productPicture"
                    />
                  </div>
                </summary>
              ...
              <details>
                ...
                <summary>
                  <div class="flex items-center gap-2">
                    ...
                    <img
                      class="w-4 h-4"
                      src="{{ asset('frontend-assets/images/icons/perfume.svg') }}"
                      alt="productPicture"
                    />
                  </div>
                </summary>
              ...
              <details>
                ...
                <summary>
                  <div class="flex items-center gap-2">
                    ...
                    <img
                      class="w-4 h-4"
                      src="{{ asset('frontend-assets/images/icons/cosmetics.svg') }}"
                      alt="productPicture"
                    />
                  </div>
                </summary>
              ...
              <details>
                ...
                <summary>
                  <div class="flex items-center gap-2">
                    ...
                    <img
                      class="w-4 h-4"
                      src="{{ asset('frontend-assets/images/icons/glasses.svg') }}"
                      alt="productPicture"
                    />
                  </div>
                </summary>
              ...
              <details>
                ...
                <summary>
                  <div class="flex items-center gap-2">
                    ...
                    <img
                      class="w-4 h-4"
                      src="{{ asset('frontend-assets/images/icons/bag.svg') }}"
                      alt="productPicture"
                    />
                  </div>
                </summary>
          ...
          >
            ...
            <div class="flex items-center justify-start gap-2">
              <div class="w-20 h-20 p-2 border shadow-lg bg-gray-300/20 rounded-md">
                <img
                  class="w-full h-full"
                  src="{{ asset('frontend-assets/images/products/2.jpg') }}"
                  alt=""
                />
              </div>
              <div class="text-gray-700">
            ...
            <div class="flex items-center justify-start gap-2">
              <div class="w-20 h-20 p-2 border shadow-lg bg-gray-300/20 rounded-md">
                <img
                  class="w-full h-full"
                  src="{{ asset('frontend-assets/images/products/3.jpg') }}"
                  alt=""
                />
              </div>
              <div class="text-gray-700">
            ...
            <div class="flex items-center justify-start gap-2">
              <div class="w-20 h-20 p-2 border shadow-lg bg-gray-300/20 rounded-md">
                <img
                  class="w-full h-full"
                  src="{{ asset('frontend-assets/images/products/4.jpg') }}"
                  alt=""
                />
              </div>
              <div class="text-gray-700">
        ...
        <div id="default-carousel" class="relative w-full" data-carousel="slide">
          ...
          <div class="relative h-56 overflow-hidden rounded-lg md:h-96">
                  ...
                  <div class="hidden duration-700 ease-in-out" data-carousel-item>
                      <img src="{{ asset('frontend-assets/images/banner-purple-1.png') }}" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                  </div>
                  <!-- Item 2 -->
                  <div class="hidden duration-700 ease-in-out" data-carousel-item>
                      <img src="{{ asset('frontend-assets/images/banner-purple-2.png') }}" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                  </div>
                  <!-- Item 3 -->
                  <div class="hidden duration-700 ease-in-out" data-carousel-item>
                      <img src="{{ asset('frontend-assets/images/banner-purple-3.png') }}" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                  </div>
                  <!-- Item 4 -->
                  <div class="hidden duration-700 ease-in-out" data-carousel-item>
                      <img src="{{ asset('frontend-assets/images/banner-purple-4.png') }}" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                  </div>
                  <!-- Item 5 -->
                  <div class="hidden duration-700 ease-in-out" data-carousel-item>
                      <img src="{{ asset('frontend-assets/images/banner-purple-5.png') }}" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                  </div>
            </div>
            <!-- Slider indicators -->
        ...
        <div class="products w-full lg:w-3/4 flex flex-col">
            ...
            <div class="NewArrivals flex flex-col gap-4">
              ...
              >
                <div class="w-20 h-20 p-2">
                  <img
                    class="w-full h-full"
                    src="{{ asset('frontend-assets/images/products/clothes-1.jpg') }}"
                    alt=""
                  />
                </div>
                <div class="text-gray-700">
              ...
              >
                <div class="w-20 h-20 p-2">
                  <img
                    class="w-full h-full"
                    src="{{ asset('frontend-assets/images/products/clothes-2.jpg') }}"
                    alt=""
                  />
                </div>
                <div class="text-gray-700">
              ...
              >
                <div class="w-20 h-20 p-2">
                  <img
                    class="w-full h-full"
                    src="{{ asset('frontend-assets/images/products/clothes-3.jpg') }}"
                    alt=""
                  />
                </div>
                <div class="text-gray-700">
              ...
              >
                <div class="w-20 h-20 p-2">
                  <img
                    class="w-full h-full"
                    src="{{ asset('frontend-assets/images/products/shirt-1.jpg') }}"
                    alt=""
                  />
                </div>
                <div class="text-gray-700">
            ...
            <div class="Trending flex flex-col gap-4">
              ...
              >
                <div class="w-20 h-20 p-2">
                  <img
                    class="w-full h-full"
                    src="{{ asset('frontend-assets/images/products/sports-5.jpg') }}"
                    alt=""
                  />
                </div>
                <div class="text-gray-700">
              ...
              >
                <div class="w-20 h-20 p-2">
                  <img
                    class="w-full h-full"
                    src="{{ asset('frontend-assets/images/products/sports-2.jpg') }}"
                    alt=""
                  />
                </div>
                <div class="text-gray-700">
              ...
              >
                <div class="w-20 h-20 p-2">
                  <img
                    class="w-full h-full"
                    src="{{ asset('frontend-assets/images/products/party-wear-1.jpg') }}"
                    alt=""
                  />
                </div>
                <div class="text-gray-700">
              ...
              >
                <div class="w-20 h-20 p-2">
                  <img
                    class="w-full h-full"
                    src="{{ asset('frontend-assets/images/products/sports-3.jpg') }}"
                    alt=""
                  />
                </div>
                <div class="text-gray-700">
            ...
            <div class="TopRated flex flex-col gap-4">
              ...
              >
                <div class="w-20 h-20 p-2">
                  <img
                    class="w-full h-full"
                    src="{{ asset('frontend-assets/images/products/watch-3.jpg') }}"
                    alt=""
                  />
                </div>
                <div class="text-gray-700">
              ...
              >
                <div class="w-20 h-20 p-2">
                  <img
                    class="w-full h-full"
                    src="{{ asset('frontend-assets/images/products/jewellery-3.jpg') }}"
                    alt=""
                  />
                </div>
                <div class="text-gray-700">
              ...
              >
                <div class="w-20 h-20 p-2">
                  <img
                    class="w-full h-full"
                    src="{{ asset('frontend-assets/images/products/perfume.jpg') }}"
                    alt=""
                  />
                </div>
                <div class="text-gray-700">
              ...
              >
                <div class="w-20 h-20 p-2">
                  <img
                    class="w-full h-full"
                    src="{{ asset('frontend-assets/images/products/belt.jpg') }}"
                    alt=""
                  />
                </div>
                <div class="text-gray-700">
          ...
          <div class="day my-10">
            ...
            >
              <img
                class="lg:w-1/2"
                src="{{ asset('frontend-assets/images/products/shampoo.jpg') }}"
                alt=""
              />
              <div class="lg:w-1/2 flex flex-col items-start gap-2 p-4">
                ...
                <button
                  class="bg-purple-500 text-white rounded-xl py-2 px-4 text-md font-semibold"
                >
                  ADD TO CART
                </button>
      ...
      >
        <div class="testimonial w-full lg:w-2/6">
          ...
          >
            ...
            <img
              class="w-6 h-6 my-4"
              src="{{ asset('frontend-assets/images/icons/quotes.svg') }}"
              alt="quotes"
            />
