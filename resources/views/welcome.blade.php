...
<body>
  ...
  <div id="newspaper" class="z-20 fixed w-screen h-screen hidden items-center justify-center">
    ...
    <div id="newspaperBox"
      ...
      <div class="hidden md:flex md:w-1/2 h-full">
        <img class="w-full h-full" src="{{ asset('frontend-assets/images/newsletter.png') }}" alt="newsletter" />
      </div>
      <div class="w-full md:w-1/2 h-full flex flex-col justify-center p-12 px-8 gap-4 relative">
        ...
        <p class="text-md text-gray-600 font-semibold">
          Subscribe the <span class="text-lg font-semibold">Nebraska v2</span> to get
          latest products and discount update.
        </p>
        <input class="border p-2" type="email" placeholder="Email Address" />
        <button class="rounded-md self-center py-2 px-3 bg-gray-900 text-white hover:bg-purple-500">
          SUBSCRIBE
        </button>
      </div>
    </div>
  ...
  <header class="header w-full">
    ...
    <div class="top-header w-screen flex flex-col items-center justify-between border-b">
      ...
      <div class="gap-4 flex flex-col sm:flex-row w-full items-center justify-between p-6 md:px-24">
        <h1 class="font-semibold text-4xl text-gray-600">Nebraska v2</h1>
            ...
            <ul
              ...
              <li>
                ...
                <ul class="flex flex-col items-start justify-start gap-2">
                  ...
                  <li>
                    <img src="{{ asset('frontend-assets/images/electronics-banner-1.jpg') }}" alt="pic" />
                  </li>
                </ul>
              </li>
              <li>
                ...
                <ul class="flex flex-col items-start justify-start gap-2">
                  ...
                  <li>
                    <img src="{{ asset('frontend-assets/images/electronics-banner-2.jpg') }}" alt="pic" />
                  </li>
                </ul>
              </li>
              <li>
                ...
                <ul class="flex flex-col items-start justify-start gap-2">
                  ...
                  <li><img src="{{ asset('frontend-assets/images/mens-banner.jpg') }}" alt="pic" /></li>
                </ul>
              </li>
              <li>
                <h3 class="border-b py-2 mb-4 text-gray-900 font-semibold">
                ...
                <ul class="flex flex-col items-start justify-start gap-2">
                  ...
                  <li>
                    <img src="{{ asset('frontend-assets/images/womens-banner.jpg') }}" alt="pic" />
                  </li>
                </ul>
              </li>
            </ul>
    ...
    <div class="mobileNavbar">
      ...
      <div
        ...
        <div class="flex justify-between border-b-2 py-4">
          <h3 class="text-purple-500">Menu</h3>
            ...
            <details>
              ...
              <summary>
                <div class="flex items-center gap-2">
                  Clothes
                  <img class="w-4 h-4" src="{{ asset('frontend-assets/images/icons/dress.svg') }}"
                    alt="productPicture" />
                </div>
              </summary>
            </details>
          ...
          <div class="border-b pb-3 text-lg text-gray-600">
            <details>
              ...
              <summary>
                <div class="flex items-center gap-2">
                  Footwear
                  <img class="w-4 h-4" src="{{ asset('frontend-assets/images/icons/shoes.svg') }}"
                    alt="productPicture" />
                </div>
              </summary>
            </details>
          ...
          <div class="border-b pb-3 text-lg text-gray-600">
            <details>
              ...
              <summary>
                <div class="flex items-center gap-2">
                  Jewelry
                  <img class="w-4 h-4" src="{{ asset('frontend-assets/images/icons/jewelry.svg') }}"
                    alt="productPicture" />
                </div>
              </summary>
            </details>
          ...
          <div class="border-b pb-3 text-lg text-gray-600">
            <details>
              ...
              <summary>
                <div class="flex items-center gap-2">
                  Perfume
                  <img class="w-4 h-4" src="{{ asset('frontend-assets/images/icons/perfume.svg') }}"
                    alt="productPicture" />
                </div>
              </summary>
            </details>
          ...
          <div class="border-b pb-3 text-lg text-gray-600">
            <details>
              ...
              <summary>
                <div class="flex items-center gap-2">
                  Cosmetics
                  <img class="w-4 h-4" src="{{ asset('frontend-assets/images/icons/cosmetics.svg') }}"
                    alt="productPicture" />
                </div>
              </summary>
            </details>
          ...
          <div class="border-b pb-3 text-lg text-gray-600">
            <details>
              ...
              <summary>
                <div class="flex items-center gap-2">
                  Glasses
                  <img class="w-4 h-4" src="{{ asset('frontend-assets/images/icons/glasses.svg') }}"
                    alt="productPicture" />
                </div>
              </summary>
            </details>
          ...
          <div class="border-b pb-3 text-lg text-gray-600">
            <details>
              ...
              <summary>
                <div class="flex items-center gap-2">
                  Bags
                  <img class="w-4 h-4" src="{{ asset('frontend-assets/images/icons/bag.svg') }}"
                    alt="productPicture" />
                </div>
              </summary>
            </details>
        ...
        <div class="bestsellers w-full h-auto mt-2 flex flex-col items-start justify-start gap-4">
          ...
          <div class="flex items-center justify-start gap-2">
            <div class="w-20 h-20 p-2 border shadow-lg bg-gray-300/20 rounded-md">
              <img class="w-full h-full" src="{{ asset('frontend-assets/images/products/1.jpg') }}"
                alt="" />
            </div>
            <div class="text-gray-700">
              ...
              <div class="flex items-center justify-start gap-4">
                <s class="text-gray-500">Rp140.000</s> <strong>Rp70.000</strong>
              </div>
            </div>
          </div>
          <div class="flex items-center justify-start gap-2">
            <div class="w-20 h-20 p-2 border shadow-lg bg-gray-300/20 rounded-md">
              <img class="w-full h-full" src="{{ asset('frontend-assets/images/products/2.jpg') }}"
                alt="" />
            </div>
            <div class="text-gray-700">
              ...
              <div class="flex items-center justify-start gap-4">
                <s class="text-gray-500">Rp50.000</s> <strong>Rp20.000</strong>
              </div>
            </div>
          </div>
          <div class="flex items-center justify-start gap-2">
            <div class="w-20 h-20 p-2 border shadow-lg bg-gray-300/20 rounded-md">
              <img class="w-full h-full" src="{{ asset('frontend-assets/images/products/3.jpg') }}"
                alt="" />
            </div>
            <div class="text-gray-700">
              ...
              <div class="flex items-center justify-start gap-4">
                <s class="text-gray-500">Rp100.000</s> <strong>Rp50.000</strong>
              </div>
            </div>
          </div>
          <div class="flex items-center justify-start gap-2">
            <div class="w-20 h-20 p-2 border shadow-lg bg-gray-300/20 rounded-md">
              <img class="w-full h-full" src="{{ asset('frontend-assets/images/products/4.jpg') }}"
                alt="" />
            </div>
            <div class="text-gray-700">
              ...
              <div class="flex items-center justify-start gap-4">
                <s class="text-gray-500">Rp240.000</s> <strong>Rp170.000</strong>
              </div>
            </div>
          </div>
        </div>
  ...
  <main>
    <!-- !banner -->
    <div class="banner mt-4 lg:-mt-2 flex items-center justify-center">
      ...
      <div id="default-carousel" class="relative w-full" data-carousel="slide">
        ...
        <div class="relative h-56 overflow-hidden rounded-lg md:h-96">
          ...
          <div class="hidden duration-700 ease-in-out" data-carousel-item>
            <img src="{{ asset('frontend-assets/images/banner-purple-1.png') }}"
              class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
          </div>
          <!-- Item 2 -->
          <div class="hidden duration-700 ease-in-out" data-carousel-item>
            <img src="{{ asset('frontend-assets/images/banner-purple-2.png') }}"
              class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
          </div>
          <!-- Item 3 -->
          <div class="hidden duration-700 ease-in-out" data-carousel-item>
            <img src="{{ asset('frontend-assets/images/banner-purple-3.png') }}"
              class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
          </div>
          <!-- Item 4 -->
          <div class="hidden duration-700 ease-in-out" data-carousel-item>
            <img src="{{ asset('frontend-assets/images/banner-purple-4.png') }}"
              class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
          </div>
          <!-- Item 5 -->
          <div class="hidden duration-700 ease-in-out" data-carousel-item>
            <img src="{{ asset('frontend-assets/images/banner-purple-5.png') }}"
              class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
          </div>
        </div>
        <!-- Slider indicators -->
      ...
      <section class="w-full min-h-auto px-8 lg:px-0 lg:w-5/6 mx-auto mt-16 flex gap-8">
        <aside class="sticky top-0 hidden lg:flex flex-col lg:w-1/4 max-h-screen">
          <div class="aside_section overflow-y-auto">
            ...
            <div class="bestsellers 2-72 h-auto mt-10 flex flex-col items-start justify-start gap-4">
              <h2 class="text-lg font-semibold">BEST SELLERS</h2>
              <div class="flex items-center justify-start gap-2">
                <div class="w-20 h-20 p-2 border shadow-lg bg-gray-300/20 rounded-md">
                  <img class="w-full h-full" src="{{ asset('frontend-assets/images/products/1.jpg') }}"
        ...
        <div class="products w-full lg:w-3/4 flex flex-col">
          <div class="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div class="NewArrivals flex flex-col gap-4">
              ...
              <div
                ...
                <div class="w-20 h-20 p-2">
                  <img class="w-full h-full" src="{{ asset('frontend-assets/images/products/clothes-1.jpg') }}"
                    alt="" />
                </div>
                <div class="text-gray-700">
                  ...
                  <h4>Clothes</h4>
                  <div class="flex items-center justify-start gap-4">
                    <strong class="text-purple-500">Rp70.000</strong>
                    <s class="text-gray-500">Rp140.000</s>
                  </div>
                </div>
              </div>
              ...
              <div
                class="w-full h-28 bg-white border shadow-sm rounded-lg flex items-center justify-start gap-2 cursor-pointer">
                <div class="w-20 h-20 p-2">
                  <img class="w-full h-full" src="{{ asset('frontend-assets/images/products/clothes-2.jpg') }}"
                    alt="" />
                </div>
                <div class="text-gray-700">
                  <h4 class="font-bold text-gray-900 text-sm text-sm">
                  ...
                  <h4>Clothes</h4>
                  <div class="flex items-center justify-start gap-4">
                    <strong class="text-purple-500">Rp210.000</strong>
                    <s class="text-gray-500">Rp240.000</s>
                  </div>
                </div>
              </div>
              <div
                class="w-full h-28 bg-white border shadow-sm rounded-lg flex items-center justify-start gap-2 cursor-pointer">
                <div class="w-20 h-20 p-2">
                  <img class="w-full h-full" src="{{ asset('frontend-assets/images/products/clothes-3.jpg') }}"
                    alt="" />
                </div>
                <div class="text-gray-700">
                  <h4 class="font-bold text-gray-900 text-sm text-sm">
                  ...
                  <h4>Clothes</h4>
                  <div class="flex items-center justify-start gap-4">
                    <strong class="text-purple-500">Rp50.000</strong>
                    <s class="text-gray-500">Rp150.000</s>
                  </div>
                </div>
              </div>
              <div
                class="w-full h-28 bg-white border shadow-sm rounded-lg flex items-center justify-start gap-2 cursor-pointer">
                <div class="w-20 h-20 p-2">
                  <img class="w-full h-full" src="{{ asset('frontend-assets/images/products/shirt-1.jpg') }}"
                    alt="" />
                </div>
                <div class="text-gray-700">
                  <h4 class="font-bold text-gray-900 text-sm text-sm">
                  ...
                  <h4>Mens Fashion</h4>
                  <div class="flex items-center justify-start gap-4">
                    <strong class="text-purple-500">Rp300.000</strong>
                    <s class="text-gray-500">Rp400.000</s>
                  </div>
                </div>
              </div>
            </div>
            <div class="Trending flex flex-col gap-4">
              ...
              <div
                class="w-full h-28 bg-white border shadow-sm rounded-lg flex items-center justify-start gap-2 cursor-pointer">
                <div class="w-20 h-20 p-2">
                  <img class="w-full h-full" src="{{ asset('frontend-assets/images/products/sports-5.jpg') }}"
                    alt="" />
                </div>
                <div class="text-gray-700">
                  <h4 class="font-bold text-gray-900 text-sm text-sm">
                  ...
                  <h4>Sports</h4>
                  <div class="flex items-center justify-start gap-4">
                    <strong class="text-purple-500">Rp820.000</strong>
                    <s class="text-gray-500">Rp10010.00</s>
                  </div>
                </div>
              </div>
              <div
                class="w-full h-28 bg-white border shadow-sm rounded-lg flex items-center justify-start gap-2 cursor-pointer">
                <div class="w-20 h-20 p-2">
                  <img class="w-full h-full" src="{{ asset('frontend-assets/images/products/sports-2.jpg') }}"
                    alt="" />
                </div>
                <div class="text-gray-700">
                  ...
                  <h4>Sports</h4>
                  <div class="flex items-center justify-start gap-4">
                    <strong class="text-purple-500">Rp780.000</strong>
                    <s class="text-gray-500">Rp930.000</s>
                  </div>
                </div>
              </div>
              <div
                class="w-full h-28 bg-white border shadow-sm rounded-lg flex items-center justify-start gap-2 cursor-pointer">
                <div class="w-20 h-20 p-2">
                  <img class="w-full h-full" src="{{ asset('frontend-assets/images/products/party-wear-1.jpg') }}"
                    alt="" />
                </div>
                <div class="text-gray-700">
                  <h4 class="font-bold text-gray-900 text-sm">
                  ...
                  <h4>Party Wear</h4>
                  <div class="flex items-center justify-start gap-4">
                    <strong class="text-purple-500">Rp270.000</strong>
                    <s class="text-gray-500">Rp320.000</s>
                  </div>
                </div>
              </div>
              <div
                class="w-full h-28 bg-white border shadow-sm rounded-lg flex items-center justify-start gap-2 cursor-pointer">
                <div class="w-20 h-20 p-2">
                  <img class="w-full h-full" src="{{ asset('frontend-assets/images/products/sports-3.jpg') }}"
                    alt="" />
                </div>
                <div class="text-gray-700">
                  <h4 class="font-bold text-gray-900 text-sm">
                  ...
                  <h4>Sports</h4>
                  <div class="flex items-center justify-start gap-4">
                    <strong class="text-purple-500">Rp120.000</strong>
                    <s class="text-gray-500">Rp240.000</s>
                  </div>
                </div>
              </div>
            ...
            <div class="TopRated flex flex-col gap-4">
              ...
              <div
                class="w-full h-28 bg-white border shadow-sm rounded-lg flex items-center justify-start gap-2 cursor-pointer">
                <div class="w-20 h-20 p-2">
                  <img class="w-full h-full" src="{{ asset('frontend-assets/images/products/watch-3.jpg') }}"
                    alt="" />
                </div>
                <div class="text-gray-700">
                  <h4 class="font-bold text-gray-900 text-sm">
                  ...
                  <h4>Watches</h4>
                  <div class="flex items-center justify-start gap-4">
                    <strong class="text-purple-500">Rp320.000</strong>
                    <s class="text-gray-500">Rp530.000</s>
                  </div>
                </div>
              </div>
              <div
                class="w-full h-28 bg-white border shadow-sm rounded-lg flex items-center justify-start gap-2 cursor-pointer">
                <div class="w-20 h-20 p-2">
                  <img class="w-full h-full" src="{{ asset('frontend-assets/images/products/jewellery-3.jpg') }}"
                    alt="" />
                </div>
                <div class="text-gray-700">
                  <h4 class="font-bold text-gray-900 text-sm">
              ...
              <div
                class="w-full h-28 bg-white border shadow-sm rounded-lg flex items-center justify-start gap-2 cursor-pointer">
                <div class="w-20 h-20 p-2">
                  <img class="w-full h-full" src="{{ asset('frontend-assets/images/products/perfume.jpg') }}"
                    alt="" />
                </div>
                <div class="text-gray-700">
                  <h4 class="font-bold text-gray-900 text-sm">
                  ...
                  <h4>Perfume</h4>
                  <div class="flex items-center justify-start gap-4">
                    <strong class="text-purple-500">Rp740.000</strong>
                    <s class="text-gray-500">Rp140.000</s>
                  </div>
                </div>
              </div>
              <div
                class="w-full h-28 bg-white border shadow-sm rounded-lg flex items-center justify-start gap-2 cursor-pointer">
                <div class="w-20 h-20 p-2">
                  <img class="w-full h-full" src="{{ asset('frontend-assets/images/products/belt.jpg') }}"
                    alt="" />
                </div>
                <div class="text-gray-700">
                  <h4 class="font-bold text-gray-900 text-sm">
                  ...
                  <h4>Belt</h4>
                  <div class="flex items-center justify-start gap-4">
                    <strong class="text-purple-500">Rp170.000</strong>
                    <s class="text-gray-500">Rp230.000</s>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="day my-10">
            ...
            <div class="mt-10 w-full h-auto border rounded-lg flex flex-col lg:flex-row justify-between">
              <img class="lg:w-1/2" src="{{ asset('frontend-assets/images/products/shampoo.jpg') }}"
                alt="" />
              <div class="lg:w-1/2 flex flex-col items-start gap-2 p-4">
                ...
                <div>
                  <strong class="text-purple-500 font-bold text-xl">Rp150.000</strong>
                  <s class="text-xl text-gray-500">Rp200.000</s>
                </div>
                <button class="bg-purple-500 text-white rounded-xl py-2 px-4 text-md font-semibold">
                  ADD TO CART
                </button>
          ...
          <div class="newProductsContainer">
            ...
            <div id="newProducts" class="newProducts grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6"></div>
          </div>
        </div>
      </section>
      ...
      <div
        ...
        <div class="testimonial w-full lg:w-2/6">
          ...
          <div style="height: 23rem" class="w-full border rounded-xl flex flex-col items-center justify-center p-4">
            <img class="w-20 h-20 rounded-full" src="{{ asset('frontend-assets/images/testimonial-1.jpg') }}"
              alt="testimonial" />
            <h2 class="text-lg font-bold text-gray-600">ALAN DOE</h2>
            <h5 class="text-md">CEO & Founder Invision</h5>
            <img class="w-6 h-6 my-4" src="{{ asset('frontend-assets/images/icons/quotes.svg') }}" alt="quotes" />
        ...
        <div class="w-full lg:w-3/6 rounded-lg flex items-center justify-center"
          style="background-image: url('{{ asset('frontend-assets/images/cta-banner.jpg') }}')">
          <div class="flex flex-col items-center justify-center p-8 gap-4 bg-gray-100/70 rounded-lg w-3/4">
            ...
            <h5 class="text-lg font-semibold text-gray-500">Starting @ Rp10</h5>
          ...
          <div style="height: 23rem"
            ...
            <div class="w-1/2 lg:w-full flex justify-center lg:justify-between items-center gap-2">
              ...
              <div>
                ...
                <p class="text-xs text-gray-600">For Order Over Rp100</p>
              </div>
            </div>
  ...
  <footer class="footer bg-[#212121]">
    <div class="brands flex flex-col justify-start items-start gap-4 px-6 py-8 md:px-8 md:py-10 lg:px-16 lg:py-12">
      <h3 class="text-purple-500 font-semibold text-md lg:text-lg">
        BRAND DIRECTORY
      </h3>
    ...
    <div class="mx-auto flex items-center justify-center flex-col gap-4 py-10 pb-20 lg:pb-10">
      <img class="w-80" src="{{ asset('frontend-assets/images/payment.png') }}" alt="payment" />
      <h4 class="text-gray-500 text-md lg:text-lg font-semibold">
        Copyright © Nebraska v2 All Rights Reserved.
      </h4>
    </div>
  </footer>
  <!--! icons -->
