...
<head>
  ...
  <!--
    - End Choices Js for replace select2
  -->
    ...
    <div class="flex flex-grow items-center justify-between px-4 py-4 shadow-2 md:px-6 2xl:px-11">
      <div class="flex items-center gap-2 sm:gap-4 lg:hidden">
        ...
        <a class="block flex-shrink-0 lg:hidden" href="index.html">
          <img src="{{ asset('tailadmin-htmlcss/src/images/logo/logo-icon.svg') }}" alt="Logo" />
        </a>
      </div>
      ...
      <nav class="mt-5 px-4 py-4 lg:mt-9 lg:px-6 bg-red" x-data="{ selected: $persist('Dashboard') }">
        ...
        <div>
          ...
          <ul class="mb-6 flex flex-col gap-1.5">
            ...
            <a :active="request() - > routeIs('sales.best-seller')" href="/sales/best-seller" wire:navigate>
              Best Seller
            </a>

            <a :active="request() - > routeIs('sales.product-sales')" href="/sales/product-sales" wire:navigate>
              Product Sales
            </a>
